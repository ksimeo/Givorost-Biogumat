...
@ContextConfiguration(locations = {"file:GivoRostRepo/src/main/webapp/WEB-INF/dispatcher-servlet.xml"})
@WebAppConfiguration
public class ProductControllerTest {
    ...
    public void prepare() {
        ...
        testProduct1 = productService.addNewProduct(new Product("Биогумат марки 1", 3.99F, 0.99F));
        testProduct2 = productService.addNewProduct(new Product("Биогумат марки 2", 2.54F, 0.51F));
    }

    @Test
    public void testAddNewProduct() throws Exception {
        Product product = new Product("Биогумат марки 3", 5.21F, 2.51F);
