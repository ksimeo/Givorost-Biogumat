...
public class UserControllerTest {
    ...
    public void prepare() {
        ...
        testUser1 = userService.addUser(new User("Назару Васильевичу", "Nazar", "Samarchuk", true));
        testUser2 = userService.addUser(new User("Макс", "Ksimeo", "max123", true));
    }
...
//    }
    ...
    public void testIsExistLogin() throws Exception {
        ...
        MvcResult res = this.mockMvc.perform(get("/isexistlogin/" + "nazar" + "/"))
                .andExpect(status().isOk())
                .andReturn();
