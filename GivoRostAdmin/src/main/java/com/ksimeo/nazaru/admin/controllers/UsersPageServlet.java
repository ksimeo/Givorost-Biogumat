...
import com.ksimeo.nazaru.admin.services.OrderService;
...
/**
 * Created by @Ksimeo on 23.03.2015
 */
@WebServlet(urlPatterns = "/WEB-INF/userspage")
public class UsersPageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            req.getRequestDispatcher("/WEB-INF/adminspage.jsp").forward(req, resp);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
